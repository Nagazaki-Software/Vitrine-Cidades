...
class AlterarDadosWidget extends StatefulWidget {
  /// pagina de alterar dados da conta
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      await currentUserReference!.update(createUsersRecordData(
                        ...
                        cpfCnpj: _model.textController4.text,
                        enderecoDoUsuario: _model.textController5.text,
                        numeroCasa: int.tryParse(_model.textController6.text),
                        complemento: _model.textController7.text,
                        bairro: _model.textController8.text,
                        cidade: _model.textController9.text,
                        estado: _model.textController10.text,
