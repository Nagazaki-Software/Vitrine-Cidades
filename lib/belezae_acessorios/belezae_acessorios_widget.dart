...
import 'belezae_acessorios_model.dart';
export 'belezae_acessorios_model.dart';

class BelezaeAcessoriosWidget extends StatefulWidget {
  /// pagina categoria com todos os produtos
  const BelezaeAcessoriosWidget({super.key});

  @override
  State<BelezaeAcessoriosWidget> createState() =>
      _BelezaeAcessoriosWidgetState();
}

class _BelezaeAcessoriosWidgetState extends State<BelezaeAcessoriosWidget> {
  late BelezaeAcessoriosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BelezaeAcessoriosModel());
