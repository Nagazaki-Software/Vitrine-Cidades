...
import 'calcados_model.dart';
export 'calcados_model.dart';

class CalcadosWidget extends StatefulWidget {
  /// pagina categoria com todos os produtos
  const CalcadosWidget({super.key});

  @override
  State<CalcadosWidget> createState() => _CalcadosWidgetState();
}

class _CalcadosWidgetState extends State<CalcadosWidget> {
  late CalcadosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CalcadosModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<SeusprodutosRecord>>(
      stream: querySeusprodutosRecord(
        queryBuilder: (seusprodutosRecord) => seusprodutosRecord
            .where(Filter.or(
              Filter(
                'categoria',
                isEqualTo: 'Sapatos Femininos',
              ),
              Filter(
                'categoria',
                isEqualTo: 'Sapatos Masculinos',
              ),
            ))
      ...
      builder: (context, snapshot) {
        ...
        List<SeusprodutosRecord> calcadosSeusprodutosRecordList =
            snapshot.data!;
                        ...
                        builder: (context) => Builder(
                          builder: (context) {
                            final item = functions
                                .buscarPorRegiao(
                                    calcadosSeusprodutosRecordList.toList(),
