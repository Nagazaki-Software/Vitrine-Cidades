...
import 'banner_container_model.dart';
export 'banner_container_model.dart';

class BannerContainerWidget extends StatefulWidget {
  /// Container que agrupa o banner
  const BannerContainerWidget({super.key});

  @override
  State<BannerContainerWidget> createState() => _BannerContainerWidgetState();
}

class _BannerContainerWidgetState extends State<BannerContainerWidget> {
  late BannerContainerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BannerContainerModel());
                                                      ...
                                                      child: Stack(
                                                        children: [
                                                          ContainerBannerInicialWidget(
                                                            key: Key(
                                                                'Keyfgw_${anuncioIndex}_of_${anuncio.length}'),
                                                            img:
                                                                anuncioItem.img,
                                                          ),
                                                          Stack(
