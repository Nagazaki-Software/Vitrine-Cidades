...
import 'banner_container_copy2_model.dart';
export 'banner_container_copy2_model.dart';

class BannerContainerCopy2Widget extends StatefulWidget {
  /// Container que agrupa o banner
  const BannerContainerCopy2Widget({super.key});

  @override
  State<BannerContainerCopy2Widget> createState() =>
      _BannerContainerCopy2WidgetState();
}

class _BannerContainerCopy2WidgetState
    extends State<BannerContainerCopy2Widget> {
  late BannerContainerCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BannerContainerCopy2Model());
                                        ...
                                        if (anuncio.isEmpty) {
                                          return Container(
                                            width: MediaQuery.sizeOf(context)
                                                ...
                                                1.0,
                                            height: 200.0,
                                            child: BannerContainerCopyWidget(),
                                          );
                                        }
                                                    ...
                                                    child: Stack(
                                                      children: [
                                                        ContainerBannerInicialWidget(
                                                          key: Key(
                                                              'Keygfs_${anuncioIndex}_of_${anuncio.length}'),
                                                          img: anuncioItem.img,
                                                        ),
                                                        Stack(
                                                          children: [
