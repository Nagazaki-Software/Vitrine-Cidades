...
import 'banner_container_para_servicos_model.dart';
export 'banner_container_para_servicos_model.dart';

class BannerContainerParaServicosWidget extends StatefulWidget {
  /// Container que agrupa o banner
  const BannerContainerParaServicosWidget({super.key});

  @override
  State<BannerContainerParaServicosWidget> createState() =>
      _BannerContainerParaServicosWidgetState();
}

class _BannerContainerParaServicosWidgetState
    extends State<BannerContainerParaServicosWidget> {
  late BannerContainerParaServicosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BannerContainerParaServicosModel());
                                                  ...
                                                  child: Stack(
                                                    children: [
                                                      ContainerBannerInicialWidget(
                                                        key: Key(
                                                            'Keywv3_${anuncioIndex}_of_${anuncio.length}'),
                                                        img: anuncioItem.img,
                                                      ),
                                                      Stack(
                                                        children: [
