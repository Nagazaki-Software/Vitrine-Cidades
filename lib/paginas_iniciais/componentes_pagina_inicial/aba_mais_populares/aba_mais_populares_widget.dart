...
import 'aba_mais_populares_model.dart';
export 'aba_mais_populares_model.dart';

class AbaMaisPopularesWidget extends StatefulWidget {
  const AbaMaisPopularesWidget({super.key});

  @override
  State<AbaMaisPopularesWidget> createState() => _AbaMaisPopularesWidgetState();
}

class _AbaMaisPopularesWidgetState extends State<AbaMaisPopularesWidget> {
  late AbaMaisPopularesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AbaMaisPopularesModel());
