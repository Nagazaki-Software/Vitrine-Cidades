...
import 'dart:ui';
import 'endereco_antes_da_compra_widget.dart' show EnderecoAntesDaCompraWidget;
...
class EnderecoAntesDaCompraModel
    extends FlutterFlowModel<EnderecoAntesDaCompraWidget> {
  ...
  // Stores action output result for [Backend Call - API (puxarCEP)] action in TextField widget.
