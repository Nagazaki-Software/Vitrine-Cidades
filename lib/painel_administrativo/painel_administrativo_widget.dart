...
import '/components/nenhum_produto_adicionado_widget.dart';
...
class PainelAdministrativoWidget extends StatefulWidget {
  ...
  const PainelAdministrativoWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<LojistasRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<LojistasRecord> painelAdministrativoLojistasRecordList =
            snapshot.data!;
        final painelAdministrativoLojistasRecord =
            painelAdministrativoLojistasRecordList.isNotEmpty
                ? painelAdministrativoLojistasRecordList.first
                : null;
            ...
            appBar: AppBar(
              ...
              actions: [
                FlutterFlowIconButton(
                  ...
                  onPressed: () async {
                    context.pushNamed(
                      'editarPerfilDeLojista',
                      queryParameters: {
                        'lojistas': serializeParam(
                          painelAdministrativoLojistasRecord?.reference,
                    ...
                    children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          valueOrDefault<String>(
                                            painelAdministrativoLojistasRecord
                                ...
                                Row(
                                  ...
                                  children: [
                                    FutureBuilder<int>(
                                      future: querySeusprodutosRecordCount(
                                        parent:
                                            painelAdministrativoLojistasRecord
                                                ?.reference,
                                      ),
                      ...
                      Wrap(
                        ...
                        children: [
                          ...
                          if (painelAdministrativoLojistasRecord?.qualPlano ==
                              'premium')
                            InkWell(
                              splashColor: Colors.transparent,
                              focusColor: Colors.transparent,
                              ...
                              children: [
                                ...
                                StreamBuilder<List<SeusprodutosRecord>>(
                                  stream: querySeusprodutosRecord(
                                    parent: painelAdministrativoLojistasRecord
                                        ?.reference,
                                    limit: 3,
                                  ),
                                  builder: (context, snapshot) {
                                    ...
                                    if (listViewSeusprodutosRecordList
                                        .isEmpty) {
                                      return NenhumProdutoAdicionadoWidget();
                                    }
