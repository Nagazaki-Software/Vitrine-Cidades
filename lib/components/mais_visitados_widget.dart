...
import 'mais_visitados_model.dart';
export 'mais_visitados_model.dart';

class MaisVisitadosWidget extends StatefulWidget {
  /// mais vendidos com todos os produtos com quantas pessoas visitou e preco
  /// com desconto
  const MaisVisitadosWidget({super.key});

  @override
  State<MaisVisitadosWidget> createState() => _MaisVisitadosWidgetState();
}

class _MaisVisitadosWidgetState extends State<MaisVisitadosWidget> {
  late MaisVisitadosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MaisVisitadosModel());
      ...
      children: [
        StreamBuilder<List<SeusprodutosRecord>>(
          stream: querySeusprodutosRecord(
            queryBuilder: (seusprodutosRecord) => seusprodutosRecord.where(
              'clicks',
              isGreaterThan: 1,
            ),
          ),
