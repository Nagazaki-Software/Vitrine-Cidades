...
class ItensDoCarrinhoRecord extends FirestoreRecord {
  ItensDoCarrinhoRecord._(
  ...
  static Query<Map<String, dynamic>> collection([DocumentReference? parent]) =>
      parent != null
          ? parent.collection('itensDoCarrinho')
          : FirebaseFirestore.instance.collectionGroup('itensDoCarrinho');

  static DocumentReference createDoc(DocumentReference parent, {String? id}) =>
      parent.collection('itensDoCarrinho').doc(id);

  static Stream<ItensDoCarrinhoRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => ItensDoCarrinhoRecord.fromSnapshot(s));

  static Future<ItensDoCarrinhoRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => ItensDoCarrinhoRecord.fromSnapshot(s));

  static ItensDoCarrinhoRecord fromSnapshot(DocumentSnapshot snapshot) =>
      ItensDoCarrinhoRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static ItensDoCarrinhoRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      ItensDoCarrinhoRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'ItensDoCarrinhoRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is ItensDoCarrinhoRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createItensDoCarrinhoRecordData({
  String? name,
  String? description,
...
class ItensDoCarrinhoRecordDocumentEquality
    implements Equality<ItensDoCarrinhoRecord> {
  const ItensDoCarrinhoRecordDocumentEquality();

  @override
  bool equals(ItensDoCarrinhoRecord? e1, ItensDoCarrinhoRecord? e2) {
  ...
  @override
  int hash(ItensDoCarrinhoRecord? e) => const ListEquality().hash([
        e?.name,
        e?.description,
        e?.specifications,
        e?.price,
  ...
  @override
  bool isValidKey(Object? o) => o is ItensDoCarrinhoRecord;
}
