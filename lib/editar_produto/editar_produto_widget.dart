...
class EditarProdutoWidget extends StatefulWidget {
  ...
  final SeusprodutosRecord? produtoRef;
...
class _EditarProdutoWidgetState extends State<EditarProdutoWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<SeusprodutosRecord>(
      future: SeusprodutosRecord.getDocumentOnce(widget!.produtoRef!.reference),
      builder: (context, snapshot) {
        ...
        final editarProdutoSeusprodutosRecord = snapshot.data!;
                                          ...
                                          Padding(
                                            ...
                                            child: TextFormField(
                                              controller:
                                                ...
                                                text:
                                                    editarProdutoSeusprodutosRecord
                                                        .name,
                                              ),
                                              focusNode:
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                await widget!.produtoRef!.reference
                                    .update(createSeusprodutosRecordData(
                                  name: _model.textController1.text,
                                  description: editarProdutoSeusprodutosRecord
                                      .description,
                                  price: editarProdutoSeusprodutosRecord.price,
                                  estoque:
                                      int.tryParse(_model.textController3.text),
                                  inativo: _model.switchValue2,
                                ));
                                context.safePop();
                              },
