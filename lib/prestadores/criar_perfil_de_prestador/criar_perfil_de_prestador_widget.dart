...
import 'criar_perfil_de_prestador_model.dart';
export 'criar_perfil_de_prestador_model.dart';

class CriarPerfilDePrestadorWidget extends StatefulWidget {
  const CriarPerfilDePrestadorWidget({super.key});

  @override
  State<CriarPerfilDePrestadorWidget> createState() =>
      _CriarPerfilDePrestadorWidgetState();
}

class _CriarPerfilDePrestadorWidgetState
    extends State<CriarPerfilDePrestadorWidget> {
  late CriarPerfilDePrestadorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CriarPerfilDePrestadorModel());
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        validator: _model.cityTextController2Validator
                            .asValidator(context),
                        inputFormatters: [_model.cityMask2],
                      ),
                    ),
                    Align(
                          ...
                          onPressed: () async {
                            ...
                            if (_model.checkboxValue!) {
                              if (_model.checkboxPrestadorValue!) {
                                var prestadoresDeServicosRecordReference =
                                    PrestadoresDeServicosRecord.collection
                                        .doc();
                                await prestadoresDeServicosRecordReference
                                  ...
                                  descricao: _model.myBioTextController.text,
                                  ...
                                  idDoPrestador: random_data.randomString(
                                    10,
                                    10,
                                    false,
                                    true,
                                ...
                                _model.prestador = PrestadoresDeServicosRecord
                                    .getDocumentFromData(
                                        createPrestadoresDeServicosRecordData(
                                          nomeEmpresarialDoComerciante: _model
                                        ...
                                        prestadoresDeServicosRecordReference);
                              } else if (_model.checkboxLojistaValue!) {
                                var lojistasRecordReference =
                                    LojistasRecord.collection.doc();
                                await lojistasRecordReference
                                  ...
                                  fotoDePerfil: _model.uploadedFileUrl2,
                                  idDoComerciante:
                                      currentUserDocument?.lojistaReference?.id,
                                  fotoDeCapa: _model.uploadedFileUrl1,
                                  telefone: _model.cityTextController2.text,
                                  uidDoUsuario: currentUserReference?.id,
                                  ...
                                  produtosDisponiveisParaAdicionar: () {
                                    if (FFAppState().tipoDeAssinatura ==
                                        'basico') {
                                      return 5;
                                    } else if (FFAppState().tipoDeAssinatura ==
                                        'profissional') {
                                      return 20;
                                    } else if (FFAppState().tipoDeAssinatura ==
                                        'premium') {
                                  ...
                                  idDoLojista: random_data.randomString(
                                    10,
                                    10,
                                    false,
                                    true,
                                ...
                                _model.lojista =
                                    LojistasRecord.getDocumentFromData(
                              ...
                              await currentUserReference!
                                ...
                                plano: FFAppState().tipoDeAssinatura,
                              ));
