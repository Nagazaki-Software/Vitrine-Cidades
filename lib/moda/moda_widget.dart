  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<SeusprodutosRecord>>(
      stream: querySeusprodutosRecord(
        queryBuilder: (seusprodutosRecord) => seusprodutosRecord
            .where(Filter.or(
              Filter(
                'categoria',
                isEqualTo: 'Roupas Femininas',
              ),
              Filter(
                'categoria',
                isEqualTo: 'Roupas Plus Size',
              ),
              Filter(
                'categoria',
                isEqualTo: 'Roupa Masculina',
              ),
              Filter(
                'categoria',
                isEqualTo: 'Moda Infantil',
              ),
              Filter(
                'categoria',
                isEqualTo: 'Assesórios de Moda',
              ),
              Filter(
                'categoria',
                isEqualTo: 'Bolsas Femininas',
              ),
              Filter(
                'categoria',
                isEqualTo: 'Bolsas Masculinas',
              ),
            ))
            .orderBy('clicks', descending: true)
            .orderBy('tipoDeAssinatura'),
      ),
      builder: (context, snapshot) {
        ...
        List<SeusprodutosRecord> modaSeusprodutosRecordList = snapshot.data!;
                        ...
                        builder: (context) => Builder(
                          builder: (context) {
                            final item = functions
                                .buscarPorRegiao(
                                    modaSeusprodutosRecordList.toList(),
